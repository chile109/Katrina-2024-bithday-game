...
function preload ()
{
    ...
    this.load.image("nuts", "assets/images/pac man pill/nuts.png");
    this.load.image("jubo", "assets/images/jubo.png");
    ...
    this.load.image("picture", "assets/images/Picture.jpg");
}
    ...
    map.filterObjects("Objects", function (value, index, array) {
        if(value.name == "Pill") {
            let pill=scene.physics.add
                .sprite(value.x + offset, value.y - offset, "nuts");
            pill.setScale(0.02);
            pills.add(pill);
            pillsCount++;
        }
